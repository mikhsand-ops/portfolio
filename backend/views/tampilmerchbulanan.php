...
<center>
       ...
       <td><button><a href="<?php echo base_url().'Ckasir/detailomsetbulanan/'. $x->id_merchant; ?>">Detail</a></button>
          <button><a href="<?php echo base_url().'Ckasir/cetakomset/'. $x->id_merchant; ?>">Cetak</a></button></td>
    </tr>
    <?php } ?>
              </table>
              <br>
        ...
        <button><a href="<?php echo base_url();?>Ckasir/tampilmerchbulanans">Per-bulan</a></button>
              <?php 
